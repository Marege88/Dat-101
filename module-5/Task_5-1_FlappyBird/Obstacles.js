...
export class TObstacles {
    ...
    constructor ( aSpcvs, aSPI){
        ...
        const minTop = -this.#spi.height + MinimumProtrusion; // minimum top position for upper obstacles.
        ...
        const minBottom = 400 - MinimumProtrusion; //minimum bottom position for lower obstacles.
        let topWithGap = this.#spi.height + top + gap; // initial position of the bottom obstacle based on the height of the of the sprite, gap and top.
        if (topWithGap > minBottom){
            //Top with gap is to low, adjust top and keep the gap constant.
